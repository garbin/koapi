...
const graphql = module.exports = {
  ...
  presets: {
    async mutation (requestInfo, queryInfo) {
      const { type, create = {}, update = {}, remove = {} } = queryInfo
      ...
      await graphql.presets.remove(requestInfo, Object.assign({}, remove, {
        type,
        variables: Object.assign({ id }, remove.variables)
      }))
      return created
    },
