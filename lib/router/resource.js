...
module.exports = class Resource extends Base {
  get model () { throw new Error('model sure be set on defination') }
  get nameSpace () { return this.model.prototype.tableName }
  get name () { return pluralize.singular(this.nameSpace) }
  get idAttribute () { return this.model.prototype.idAttribute }
  get idType () { return '\\d+' }
  get foreignId () { return `${this.name}_id` }
  get listRoute () { return `/${this.nameSpace}` }
  get itemRoute () { return `/${this.nameSpace}/:${this.idAttribute}` }
  collection (ctx) { return this.model.collection() }
